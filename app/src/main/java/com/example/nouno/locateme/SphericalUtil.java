...
import static com.example.nouno.locateme.MathUtils.EARTH_RADIUS;
import static java.lang.Math.*;
import static com.example.nouno.locateme.MathUtils.*;
...
public class SphericalUtil {
    ...
    public static LatLng computeOffsetOrigin(LatLng to, double distance, double heading) {
        ...
        double fromLngRadians = toRadians(to.getLatitude()) -
